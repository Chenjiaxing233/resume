  ...
  experience: [
    {
      ...
      bullets: [
        "负责公司核心前端业务系统的开发与优化，包括但不限于：中后台系统、大模型标注系统、小程序、h5；支撑bff层node服务，确保系统稳定高效运行；",
        "负责团队基础设施的构建，包括ui组件库、自动化脚本、自动化测试等；",
        "与产品、后端、设计等多部门协作，推动需求落地与方案优化；",
        "负责开放平台、云平台、AI 标注等多项目并行开发，覆盖开放接口、实时通信、AI 交互与三维标注场景。",
      ],
    },
    {
